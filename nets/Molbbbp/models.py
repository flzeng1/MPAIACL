...
from common_utils import contrast_loss, triplet_contrast_loss
...
class CausalAdvGNNMol(torch.nn.Module):
    ...
    def __init__(self, num_class,
        ...
        self.num_class = num_class
        # self.wasserstein_distance = nn.MSELoss()
        self.wasserstein_distance = triplet_contrast_loss
    ...
    def forward_attack(self, data, model):
        ...
        # loss_dis = self.wasserstein_distance(h_graph_adv, h_graph_ori)
        loss_dis = self.wasserstein_distance(h_graph_ori, h_graph_adv)
