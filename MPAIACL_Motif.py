...
from common_utils import set_random_seed, info_nce, info_nce_DA, \
    print_log, get_OPT, get_schedule, set_network_train_eval, parameter_visualization, contrast_loss
...
def train():
    ...
    att_reg, att_dis, att_loss = 0, 0, 0
    ...
    for step, data in enumerate(train_loader):
        ...
        loss_cl_con = cl_criterion_DA(h_graph_cau, h_graph_adv, 1)
...
dataset, _ = GOODMotif.load(args.path, domain=args.domain, shift=args.shift, generate=False)
