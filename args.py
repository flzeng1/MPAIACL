...
def parse_args():
    ...
    parser.add_argument('--causaler_lr', type=float, default=3e-4, help='Learning rate')
    parser.add_argument('--attacker_lr', type=float, default=3e-4, help='Learning rate')
    ...
    parser.add_argument('--domain', type=str, default='size', choices=['size', 'scaffold', 'basis'],
                        help='Molbbbp: [size, scaffold],'
                             'Motif: [size, basis],'
                             'MolHiv: [scaffold, size],'
                             'CMNIST: [color],'
                             'Molbace: [size, scaffold]',)
    parser.add_argument('--shift', type=str, default='concept', help='covariate, concept')
    ...
    parser.add_argument('--con_reg', type=int, default=1)
    parser.add_argument('--verbose_path', type=str, default='./runs')
    parser.add_argument('--early_stop', type=bool, default=True)
    parser.add_argument('--patient', type=int, default=25)
